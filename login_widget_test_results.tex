...
UI Rendering & Component Visibility & Render sign up prompt & Sign up prompt should be visible & Prompt not found & Fail \\ \hline
...
Login Process & Loading State & Submit valid credentials & Should show loading indicator & Loading state not shown & Fail \\ \hline
\end{tabular}
\end{table*}
